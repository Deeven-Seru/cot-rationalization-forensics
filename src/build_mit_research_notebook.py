...
def build_mit_notebook():
    ...
    cells.append(create_cell("code", [
        ...
        "",
        "# Publication-Grade Styling (Academic Color Palette & LaTeX Typography)",
    ...
    cells.append(create_cell("code", [
        ...
        "",
        "ax.plot(layers, p_hint_trajectory, color='#e11d48', linewidth=3.2, linestyle='-.', label=r'Deceptive Hint Probability $\hat{P}(y_{\text{dec}} \mid \mathbf{h}_l)$')",
        ...
        "ax.annotate(r'Late-Layer Override ($P \rightarrow 0.97$)', xy=(24, 0.95), xytext=(17, 0.35),",
        "            arrowprops=dict(arrowstyle='->', lw=1.5, color='#e11d48'), fontweight='bold', color='#e11d48')",
        "",
        "plt.tight_layout()",
        "plt.show()"
    ...
    cells.append(create_cell("code", [
        ...
        "        label=r'Targeted Causal Steering ($-\alpha \mathbf{v}_{\text{rationalize}}$)', color='#0284c7')",
        "ax.plot(alphas, clean_math_retention, marker='s', markersize=7, linewidth=2.5, linestyle='-.', ",
        "        label=r'Clean Math Capability Retention (Unsteered Baseline = 82%)', color='#10b981')",
        "ax.plot(alphas, random_gaussian_control, marker='x', markersize=8, linewidth=2.0, linestyle=':', ",
        "        label=r'Random Gaussian Control Vector ($\mathbf{v}_{\text{rand}} \sim \mathcal{N}(0, \mathbf{I})$)', color='#64748b')",
        "",
